  ...
  return (
    <div className="px-10 pt-10 flex flex-col border-l border-slate-200 dark:border-slate-500 font-[HostGrotesk]" >
        ...
        <div className="mt-5 flex flex-col gap-5">
          {articles.map(article => <div className="flex flex-col gap-3">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          {topic.map(topic => <a href="#" className="px-5 py-2 rounded-full bg-gray-200/50 dark:bg-gray-600 dark:text-slate-300 border-none text-black">{topic}</a>)}
        </div>
    </div>
  );
}
